...
$Jumlah_modal = mysqli_query($conn, "SELECT SUM(jumlahModal) as total FROM modal");
$total_modal = mysqli_fetch_array($Jumlah_modal);

// Query untuk mengambil data uang masuk
$Jmasuk = mysqli_query($conn, "SELECT SUM(hargaU) as hargaU FROM keluar");
$pemasukan = mysqli_fetch_array($Jmasuk);

// Query untuk mengambil data jumlah barang
$Jumlah_B = mysqli_query($conn, "SELECT SUM(JumlahB) as jumlah FROM masuk");
$jumlahB = mysqli_fetch_array($Jumlah_B);

// Query untuk mengambil data jumlah produk
...
//    $sss = mysqli_query($conn, "select * from admin");
            ...
            echo "Query SQL mengalami kesalahan: " . mysqli_error($conn);
            }
            ?>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php
                            if (!is_null($total) && is_array($total)) {
                                echo "<b> Rp.". number_format($total['total']).",-</b>";
                            } else {
                                echo "<b> Rp.0,-</b>"; // atau nilai default lainnya
                            }
                        ?>
                    </div>
          ...
          <footer class="sticky-footer bg-white">
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span><p class="mb-1">Copyright &copy; <a href=" " style="text-decoration: none;"><b>Alya</b></a></p></span><br>
              </div>
            </div>
          </footer>
          </div>
