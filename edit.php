...
// Jika ada sesi dan ada kata sandi dalam sesi, tetapkan variabel isLoggedIn menjadi true
$isLoggedIn = isset($_SESSION['password']) && $_SESSION['password'] != '';

// Modifikasi sesuai kebutuhan, misalnya mengizinkan akses jika variabel isLoggedIn tidak terdefinisi atau false
if (!$isLoggedIn) {
    // Redirect ke halaman login jika tidak ada sesi atau tidak ada kata sandi dalam sesi
